/*Downloaded from:https://github.com/tarunsingh/progress-bar */
/*Adapted by Ruben Almeida for educational purpose up201704618@fe.up.pt */
...
(function (window) {
  function initProgressBar() {
    ...
    var createCheckPoints = function(stages, stageWidth, currentStageIndex) {
      var ul = createElement('ul', 'progress-bar-adapted', { }, '');
