<div id={{"modalPlatformEdit".$data->id}} class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Edit Platform</h6>
            ...
            <div class="modal-body text-left">
                ...
                <form action={{url('/admin/platform/'.$data->id)}} method="POST">
                    @csrf
                    <input type="text" name="platform" class="form-control mt-2" value={{$data->name}}>
            </div>
