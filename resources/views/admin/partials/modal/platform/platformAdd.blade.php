<div id="modalPlatformAdd" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header">
                <h6 class="modal-title">Add Platform</h6>
                <button type="button" class="close" data-dismiss="modal">×</button>
            </div>
            <div class="modal-body text-left">
                <span>New Platform</span>
                <form action={{url('/admin/platform')}} method="POST">
                    @csrf
                    @method('put')
                    <input type="text" name="platform" class="form-control mt-2" placeholder="Insert New Genre">
            </div>
